Feature: Scenarios based on cancellation of partial credit

  @advance
  Scenario: Create Standard opportunity and Qualify for partial credit cancellation
    ...
    And I Enter "Automation Opp Partial Credit Cancellation" on the Opportunity Name field
    ...
    And I check if the "Automation Opp Partial Credit Cancellation" opportunity was created
    ...
    And I select the installed product "Firco Continuity for SAA"
    ...
    And I click the "Opportunities" tab
    And I select an existing opportunity "Automation Opp Partial Credit Cancellation"
    ...
    Then I am able to login to SalesForce
    And I click the "Opportunities" tab
    And I search the Opportunity "Automation Opp Partial Credit Cancellation"
